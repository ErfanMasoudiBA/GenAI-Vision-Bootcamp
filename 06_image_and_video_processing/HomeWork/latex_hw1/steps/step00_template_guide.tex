\section[راهنمای قالب]{راهنمای قالب}

\textit{\small این بخش صرفاً برای نمایش امکانات قالب است (\lr{Template Guide})؛ در نسخه‌ی نهایی گزارش، این فایل را از \texttt{report.tex} حذف کنید.}

\vspace{0.4cm}
\begin{stepbox}
\field{۱. جعبه‌ی گام \lr{(stepbox)}}{
همین جعبه‌ای که این متن داخل آن است. برای هر تمرین/زیرمسئله از دستور
\lr{\texttt{\textbackslash field\{عنوان\}\{متن\}}}
داخل \lr{\texttt{stepbox}} استفاده کنید.
}
\end{stepbox}
...
\begin{codebox}[\texttt{spectral\_clustering.py}]
