...
def bbox_iou(box1, box2):
    # این تابع مقدار
    # IOU
    # را بین دو جعبه محدود کننده حساب می کند.
    # با توجه به تابع
    # _interval_overlap
    # سعی کنید
    # intersect_w
    # intersect_h
    # را بدست آورید و ادامه ی کار طبق رابطه انجام دهید.
...
def do_nms(boxes, nms_thresh):
    ...
    # تابع محاسبه 
    # non-max suppresion
    # با گرفتن لیستی از جعبه ها و آستانه سعی کنید جعبه های اضافی حول یک شی را حذف کنید
